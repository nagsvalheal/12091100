...
export default class BiPspbCgPatientInformation extends LightningElement {
  ...
  validateDate() {
    ...
    if (!this.patientDOB) {
      ...
      ).className = this.colorChnageCgPatient = 'textInput-err';
      ...
      this.template.querySelector(
        'input[data-field="Birthdate"]'
      ).className = this.colorChnageCgPatient = "textInput";
      this.template.querySelector('label[data-field="Birthdate"]').className =
        "input-label";
    }
    ...
    if (!this.patientDOB) {
      ...
      this.template
        ...
        .classList.add(this.colorChnageCgPatient = "textInput-err");
      this.template
      ...
      this.template
        .querySelector('input[data-field="Birthdate"]')
        .classList.remove(this.colorChnageCgPatient = "textInput-err");
      this.template
        .querySelector('label[data-field="Birthdate"]')
