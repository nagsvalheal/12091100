	...
	contactUs()
	{
		if (!this.userId) {
			...
			if(this.decisionForNavBar)
			{
				if(this.siteUrl)
				{
					window.location.assign(this.decidingBrandedOrUnassigned + this.publicContactUs);
				}else{
					window.location.assign(this.decidingBrandedOrUnassigned + this.publicContactUs);
				}
	...
	termsOfUse() 
	{
		if (!this.userId) {
			...
			if(this.decisionForNavBar)
			{
				if(this.siteUrl)
				{
					window.location.assign(this.decidingBrandedOrUnassigned + this.publicTermsOfUse);
				}else{
					window.location.assign(this.decidingBrandedOrUnassigned + this.publicTermsOfUse);
				}
			}else{
	...
	privacyNotice() 
	{
		if (!this.userId) {
			...
			if(this.decisionForNavBar)
			{
				if(this.siteUrl)
				{
					window.location.assign(this.decidingBrandedOrUnassigned + this.publicPrivacyNotice);
				}else{
					window.location.assign(this.decidingBrandedOrUnassigned + this.publicPrivacyNotice);
				}
			}else{
